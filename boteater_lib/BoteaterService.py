...
class createGroupV2_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i259 in range(_size255):
                        ...
                        self.contactIds.append(_elem260)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.contactIds is not None:
            ...
            for iter261 in self.contactIds:
...
class acquireGroupCallRoute_args(object):
            ...
            if fid == 2:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i280 in range(_size276):
                        ...
                        self.capabilities.append(_elem281)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.capabilities is not None:
            ...
            for iter282 in self.capabilities:
...
class cancelGroupInvitation_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i294 in range(_size290):
                        ...
                        self.contactIds.append(_elem295)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.contactIds is not None:
            oprot.writeFieldBegin('contactIds', TType.LIST, 3)
            oprot.writeListBegin(TType.STRING, len(self.contactIds))
            for iter296 in self.contactIds:
...
class kickoutFromGroup_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i301 in range(_size297):
                        ...
                        self.contactIds.append(_elem302)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.contactIds is not None:
            oprot.writeFieldBegin('contactIds', TType.LIST, 3)
            oprot.writeListBegin(TType.STRING, len(self.contactIds))
            for iter303 in self.contactIds:
...
class inviteIntoGroupCall_args(object):
            ...
            if fid == 2:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i308 in range(_size304):
                        ...
                        self.memberMids.append(_elem309)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.memberMids is not None:
            ...
            for iter310 in self.memberMids:
...
class updateGroupPreferenceAttribute_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i315 in range(_size311):
                        ...
                        self.updatedAttrs[_key316] = _val317
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.updatedAttrs is not None:
            ...
            for kiter318, viter319 in self.updatedAttrs.items():
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i349 in range(_size345):
                        _key350 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val351 = ContactStruct()
                        _val351.read(iprot)
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i365 in range(_size361):
                        _elem366 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
...
class updateSettingsAttributes2_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.SET:
                    ...
                    for _i386 in range(_size382):
                        ...
                        self.attributesToUpdate.add(_elem387)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.attributesToUpdate is not None:
            ...
            for iter388 in self.attributesToUpdate:
...
class getSettingsAttributes2_args(object):
        ...
        while True:
            ...
            if fid == 2:
                if ftype == TType.SET:
                    ...
                    (_etype399, _size396) = iprot.readSetBegin()
                    for _i400 in range(_size396):
                        _elem401 = iprot.readI32()
                        self.attributesToRetrieve.add(_elem401)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.attributesToRetrieve is not None:
            ...
            for iter402 in self.attributesToRetrieve:
...
generateUserTicket_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [TicketStruct, None], None, ),  # 0
    (1, TType.STRUCT, 'e', [TalkException, None], None, ),  # 1
)
...
class createRoomV2_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i407 in range(_size403):
                        ...
                        self.contactIds.append(_elem408)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.contactIds is not None:
            ...
            oprot.writeListBegin(TType.STRING, len(self.contactIds))
            for iter409 in self.contactIds:
...
createRoomV2_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [RoomStruct, None], None, ),  # 0
    (1, TType.STRUCT, 'e', [TalkException, None], None, ),  # 1
)
...
getRoomsV2_result.thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT, [RoomStruct, None], False), None, ),  # 0
    (1, TType.STRUCT, 'e', [TalkException, None], None, ),  # 1
)
...
class inviteIntoRoom_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i428 in range(_size424):
                        ...
                        self.contactIds.append(_elem429)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.contactIds is not None:
            oprot.writeFieldBegin('contactIds', TType.LIST, 3)
            oprot.writeListBegin(TType.STRING, len(self.contactIds))
            for iter430 in self.contactIds:
